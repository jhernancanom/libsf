...
//////
	...
	{
		{   cgc_activeControl,              sizeof(cgc_activeControl) - 1,               &iObj_set_activeControl,                &iObj_get_activeControl                 },
		{   cgc_allowOutput,                sizeof(cgc_allowOutput) - 1,                 &iObj_set_allowOutput,                  &iObj_get_allowOutput                   },
		{   cgc_fillColor,                  sizeof(cgc_fillColor) - 1,                   &iObj_set_fillColor,                    &iObj_get_fillColor                     },
		{   cgc_fillStyle,                  sizeof(cgc_fillStyle) - 1,                   &iObj_set_fillStyle,                    &iObj_get_fillStyle                     },
		{   cgc_maxHeight,                  sizeof(cgc_maxHeight) - 1,                   &iObj_set_maxHeight,                    &iObj_get_maxHeight                     },
		{   cgc_maxWidth,                   sizeof(cgc_maxWidth) - 1,                    &iObj_set_maxWidth,                     &iObj_get_maxWidth                      },
		{   cgc_maxTop,                     sizeof(cgc_maxTop) - 1,                      &iObj_set_maxTop,                       &iObj_get_maxTop                        },
		{   cgc_maxLeft,                    sizeof(cgc_maxLeft) - 1,                     &iObj_set_maxLeft,                      &iObj_get_maxLeft                       },
		{   cgc_minHeight,                  sizeof(cgc_minHeight) - 1,                   &iObj_set_minHeight,                    &iObj_get_minHeight                     },
		{   cgc_minWidth,                   sizeof(cgc_minWidth) - 1,                    &iObj_set_minWidth,                     &iObj_get_minWidth                      },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_controls,                   sizeof(cgc_controls) - 1,                    &iObj_set_controls,                     &iObj_get_controls                      },
		{   cgc_controlCount,               sizeof(cgc_controlCount) - 1,                &iObj_set_controlCount,                 &iObj_get_controlCount                  },
		{   cgc_objects,                    sizeof(cgc_objects) - 1,                     &iObj_set_objects,                      &iObj_get_objects                       },
		{   cgc_borderStyle,                sizeof(cgc_borderStyle) - 1,                 &iObj_set_borderStyle,                  &iObj_get_borderStyle                   },
		{   cgc_caption,                    sizeof(cgc_caption) - 1,                     &iObj_set_caption,                      &iObj_get_caption                       },
		{   cgc_foreColor,                  sizeof(cgc_foreColor) - 1,                   &iObj_set_foreColor,                    &iObj_get_foreColor                     },
		{   cgc_backColor,                  sizeof(cgc_backColor) - 1,                   &iObj_set_backColor,                    &iObj_get_backColor                     },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_enabled,                    sizeof(cgc_enabled) - 1,                     &iObj_set_enabled,                      &iObj_get_enabled                       },
		{   cgc_fontBold,                   sizeof(cgc_fontBold) - 1,                    &iObj_set_fontBold,                     &iObj_get_fontBold                      },
		{   cgc_fontCharSet,                sizeof(cgc_fontCharSet) - 1,                 &iObj_set_fontCharSet,                  &iObj_get_fontCharSet                   },
		{   cgc_fontCondense,               sizeof(cgc_fontCondense) - 1,                &iObj_set_fontCondense,                 &iObj_get_fontCondense                  },
		{   cgc_fontExtend,                 sizeof(cgc_fontExtend) - 1,                  &iObj_set_fontExtend,                   &iObj_get_fontExtend                    },
		{   cgc_fontItalic,                 sizeof(cgc_fontItalic) - 1,                  &iObj_set_fontItalic,                   &iObj_get_fontItalic                    },
		{   cgc_fontName,                   sizeof(cgc_fontName) - 1,                    &iObj_set_fontName,                     &iObj_get_fontName                      },
		{   cgc_fontOutline,                sizeof(cgc_fontOutline) - 1,                 &iObj_set_fontOutline,                  &iObj_get_fontOutline                   },
		{   cgc_fontShadow,                 sizeof(cgc_fontShadow) - 1,                  &iObj_set_fontShadow,                   &iObj_get_fontShadow                    },
		{   cgc_fontSize,                   sizeof(cgc_fontSize) - 1,                    &iObj_set_fontSize,                     &iObj_get_fontSize                      },
		{   cgc_fontStrikeThru,             sizeof(cgc_fontStrikeThru) - 1,              &iObj_set_fontStrikeThru,               &iObj_get_fontStrikeThru                },
		{   cgc_fontUnderline,              sizeof(cgc_fontUnderline) - 1,               &iObj_set_fontUnderline,                &iObj_get_fontUnderline                 },
		{   cgc_height,                     sizeof(cgc_height) - 1,                      &iObj_set_height,                       &iObj_get_height                        },
		{   cgc_helpContextID,              sizeof(cgc_helpContextID) - 1,               &iObj_set_helpContextID,                &iObj_get_helpContextID                 },
		{   cgc_hWnd,                       sizeof(cgc_hWnd) - 1,                        &iObj_set_hWnd,                         &iObj_get_hWnd                          },
		{   cgc_keyPreview,                 sizeof(cgc_keyPreview) - 1,                  &iObj_set_keyPreview,                   &iObj_get_keyPreview                    },
		{   cgc_left,                       sizeof(cgc_left) - 1,                        &iObj_set_left,                         &iObj_get_left                          },
		{   cgc_mouseIcon,                  sizeof(cgc_mouseIcon) - 1,                   &iObj_set_mouseIcon,                    &iObj_get_mouseIcon                     },
		{   cgc_mousePointer,               sizeof(cgc_mousePointer) - 1,                &iObj_set_mousePointer,                 &iObj_get_mousePointer                  },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_parent,                     sizeof(cgc_parent) - 1,                      &iObj_set_parent,                       &iObj_get_parent                        },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_icon,                       sizeof(cgc_icon) - 1,                        &iObj_set_icon,                         &iObj_get_icon                          },
		{   cgc_picture,                    sizeof(cgc_picture) - 1,                     &iObj_set_picture,                      &iObj_get_picture                       },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_top,                        sizeof(cgc_top) - 1,                         &iObj_set_top,                          &iObj_get_top                           },
		{   cgc_visible,                    sizeof(cgc_visible) - 1,                     &iObj_set_visible,                      &iObj_get_visible                       },
		{   cgc_width,                      sizeof(cgc_width) - 1,                       &iObj_set_width,                        &iObj_get_width                         },
		{   cgc_zoomBox,                    sizeof(cgc_zoomBox) - 1,                     &iObj_set_zoomBox,                      &iObj_get_zoomBox                       },
		{   NULL,                           0,                                           0,                                      0                                       }
	};
	...
	{
		{   cgc_alignment,                  sizeof(cgc_alignment) - 1,                   &iObj_set_alignment,                    &iObj_get_alignment                     },
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_autoSize,                   sizeof(cgc_autoSize) - 1,                    &iObj_set_autoSize,                     &iObj_get_autoSize                      },
		{   cgc_backStyle,                  sizeof(cgc_backStyle) - 1,                   &iObj_set_backStyle,                    &iObj_get_backStyle                     },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_caption,                    sizeof(cgc_caption) - 1,                     &iObj_set_caption,                      &iObj_get_caption                       },
		{   cgc_centered,                   sizeof(cgc_centered) - 1,                    &iObj_set_centered,                     &iObj_get_centered                      },
		{   cgc_colorScheme,                sizeof(cgc_colorScheme) - 1,                 &iObj_set_colorScheme,                  &iObj_get_colorScheme                   },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		{   cgc_foreColor,                  sizeof(cgc_foreColor) - 1,                   &iObj_set_foreColor,                    &iObj_get_foreColor                     },
		{   cgc_backColor,                  sizeof(cgc_backColor) - 1,                   &iObj_set_backColor,                    &iObj_get_backColor                     },
		{   cgc_disabledBackColor,          sizeof(cgc_disabledBackColor) - 1,           &iObj_set_disabledBackColor,            &iObj_get_disabledBackColor             },
		{   cgc_disabledForeColor,          sizeof(cgc_disabledForeColor) - 1,           &iObj_set_disabledForeColor,            &iObj_get_disabledForeColor             },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_controlSource,              sizeof(cgc_controlSource) - 1,               &iObj_set_controlSource,                &iObj_get_controlSource                 },
		{   cgc_dragIcon,                   sizeof(cgc_dragIcon) - 1,                    &iObj_set_dragIcon,                     &iObj_get_dragIcon                      },
		{   cgc_dragMode,                   sizeof(cgc_dragMode) - 1,                    &iObj_set_dragMode,                     &iObj_get_dragMode                      },
		{   cgc_enabled,                    sizeof(cgc_enabled) - 1,                     &iObj_set_enabled,                      &iObj_get_enabled                       },
		{   cgc_fontBold,                   sizeof(cgc_fontBold) - 1,                    &iObj_set_fontBold,                     &iObj_get_fontBold                      },
		{   cgc_fontCharSet,                sizeof(cgc_fontCharSet) - 1,                 &iObj_set_fontCharSet,                  &iObj_get_fontCharSet                   },
		{   cgc_fontCondense,               sizeof(cgc_fontCondense) - 1,                &iObj_set_fontCondense,                 &iObj_get_fontCondense                  },
		...
		{   cgc_mousePointer,               sizeof(cgc_mousePointer) - 1,                &iObj_set_mousePointer,                 &iObj_get_mousePointer                  },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_oLEDragMode,                sizeof(cgc_oLEDragMode) - 1,                 &iObj_set_oLEDragMode,                  &iObj_get_oLEDragMode                   },
		{   cgc_oLEDragPicture,             sizeof(cgc_oLEDragPicture) - 1,              &iObj_set_oLEDragPicture,               &iObj_get_oLEDragPicture                },
		{   cgc_oLEDropEffects,             sizeof(cgc_oLEDropEffects) - 1,              &iObj_set_oLEDropEffects,               &iObj_get_oLEDropEffects                },
		{   cgc_oLEDropHasData,             sizeof(cgc_oLEDropHasData) - 1,              &iObj_set_oLEDropHasData,               &iObj_get_oLEDropHasData                },
		{   cgc_parent,                     sizeof(cgc_parent) - 1,                      &iObj_set_parent,                       &iObj_get_parent                        },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_picture,                    sizeof(cgc_picture) - 1,                     &iObj_set_picture,                      &iObj_get_picture                       },
		{   cgc_pictureMargin,              sizeof(cgc_pictureMargin) - 1,               &iObj_set_pictureMargin,                &iObj_get_pictureMargin                 },
		{   cgc_picturePosition,            sizeof(cgc_picturePosition) - 1,             &iObj_set_picturePosition,              &iObj_get_picturePosition               },
		{   cgc_pictureSpacing,             sizeof(cgc_pictureSpacing) - 1,              &iObj_set_pictureSpacing,               &iObj_get_pictureSpacing                },
		{   cgc_disabledPicture,            sizeof(cgc_disabledPicture) - 1,             &iObj_set_disabledPicture,              &iObj_get_disabledPicture               },
		{   cgc_downPicture,                sizeof(cgc_downPicture) - 1,                 &iObj_set_downPicture,                  &iObj_get_downPicture                   },
		{   cgc_readOnly,                   sizeof(cgc_readOnly) - 1,                    &iObj_set_readOnly,                     &iObj_get_readOnly                      },
		{   cgc_rightToLeft,                sizeof(cgc_rightToLeft) - 1,                 &iObj_set_rightToLeft,                  &iObj_get_rightToLeft                   },
		{   cgc_specialEffect,              sizeof(cgc_specialEffect) - 1,               &iObj_set_specialEffect,                &iObj_get_specialEffect                 },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
		{   cgc_style,                      sizeof(cgc_style) - 1,                       &iObj_set_style,                        &iObj_get_style                         },
		{   cgc_tabIndex,                   sizeof(cgc_tabIndex) - 1,                    &iObj_set_tabIndex,                     &iObj_get_tabIndex                      },
		{   cgc_tabStop,                    sizeof(cgc_tabStop) - 1,                     &iObj_set_tabStop,                      &iObj_get_tabStop                       },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_terminateRead,              sizeof(cgc_terminateRead) - 1,               &iObj_set_terminateRead,                &iObj_get_terminateRead                 },
		{   cgc_themes,                     sizeof(cgc_themes) - 1,                      &iObj_set_themes,                       &iObj_get_themes                        },
		{   cgc_toolTipText,                sizeof(cgc_toolTipText) - 1,                 &iObj_set_toolTipText,                  &iObj_get_toolTipText                   },
		{   cgc_top,                        sizeof(cgc_top) - 1,                         &iObj_set_top,                          &iObj_get_top                           },
		{   cgc_value,                      sizeof(cgc_value) - 1,                       &iObj_set_value,                        &iObj_get_value                         },
		{   cgc_visible,                    sizeof(cgc_visible) - 1,                     &iObj_set_visible,                      &iObj_get_visible                       },
		{   cgc_whatsThisHelpID,            sizeof(cgc_whatsThisHelpID) - 1,             &iObj_set_whatsThisHelpID,              &iObj_get_whatsThisHelpID               },
		{   cgc_width,                      sizeof(cgc_width) - 1,                       &iObj_set_width,                        &iObj_get_width                         },
		{   cgc_wordWrap,                   sizeof(cgc_wordWrap) - 1,                    &iObj_set_wordWrap,                     &iObj_get_wordWrap                      },
		{   NULL,                           0,                                           0,                                      0                                       }
	};
	...
	SPropertyMap gcProps_button[] = 
	{
		...
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_cancel,                     sizeof(cgc_cancel) - 1,                      &iObj_set_cancel,                       &iObj_get_cancel                        },
		{   cgc_default,                    sizeof(cgc_default) - 1,                     &iObj_set_default,                      &iObj_get_default                       },
		{   cgc_caption,                    sizeof(cgc_caption) - 1,                     &iObj_set_caption,                      &iObj_get_caption                       },
		{   cgc_colorScheme,                sizeof(cgc_colorScheme) - 1,                 &iObj_set_colorScheme,                  &iObj_get_colorScheme                   },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		{   cgc_foreColor,                  sizeof(cgc_foreColor) - 1,                   &iObj_set_foreColor,                    &iObj_get_foreColor                     },
		...
		{   cgc_oLEDropEffects,             sizeof(cgc_oLEDropEffects) - 1,              &iObj_set_oLEDropEffects,               &iObj_get_oLEDropEffects                },
		{   cgc_oLEDropHasData,             sizeof(cgc_oLEDropHasData) - 1,              &iObj_set_oLEDropHasData,               &iObj_get_oLEDropHasData                },
		{   cgc_oLEDropMode,                sizeof(cgc_oLEDropMode) - 1,                 &iObj_set_oLEDropMode,                  &iObj_get_oLEDropMode                   },
		{   cgc_parent,                     sizeof(cgc_parent) - 1,                      &iObj_set_parent,                       &iObj_get_parent                        },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_picture,                    sizeof(cgc_picture) - 1,                     &iObj_set_picture,                      &iObj_get_picture                       },
		{   cgc_pictureMargin,              sizeof(cgc_pictureMargin) - 1,               &iObj_set_pictureMargin,                &iObj_get_pictureMargin                 },
		...
		{   cgc_top,                        sizeof(cgc_top) - 1,                         &iObj_set_top,                          &iObj_get_top                           },
		{   cgc_visible,                    sizeof(cgc_visible) - 1,                     &iObj_set_visible,                      &iObj_get_visible                       },
		{   cgc_visualEffect,               sizeof(cgc_visualEffect) - 1,                &iObj_set_visualEffect,                 &iObj_get_visualEffect                  },
		{   cgc_whatsThisHelpID,            sizeof(cgc_whatsThisHelpID) - 1,             &iObj_set_whatsThisHelpID,              &iObj_get_whatsThisHelpID               },
		{   cgc_width,                      sizeof(cgc_width) - 1,                       &iObj_set_width,                        &iObj_get_width                         },
		{   cgc_wordWrap,                   sizeof(cgc_wordWrap) - 1,                    &iObj_set_wordWrap,                     &iObj_get_wordWrap                      },
		{   NULL,                           0,                                           0,                                      0                                       }
	...
	SPropertyMap gcProps_cmdgroup[] = 
	{
		...
		{   cgc_autoSize,                   sizeof(cgc_autoSize) - 1,                    &iObj_set_autoSize,                     &iObj_get_autoSize                      },
		{   cgc_backStyle,                  sizeof(cgc_backStyle) - 1,                   &iObj_set_backStyle,                    &iObj_get_backStyle                     },
		{   cgc_buttonCount,                sizeof(cgc_buttonCount) - 1,                 &iObj_set_buttonCount,                  &iObj_get_buttonCount                   },
		{   cgc_borderColor,                sizeof(cgc_borderColor) - 1,                 &iObj_set_borderColor,                  &iObj_get_borderColor                   },
		{   cgc_borderStyle,                sizeof(cgc_borderStyle) - 1,                 &iObj_set_borderStyle,                  &iObj_get_borderStyle                   },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		{   cgc_backColor,                  sizeof(cgc_backColor) - 1,                   &iObj_set_backColor,                    &iObj_get_backColor                     },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		...
		{   cgc_helpContextID,              sizeof(cgc_helpContextID) - 1,               &iObj_set_helpContextID,                &iObj_get_helpContextID                 },
		{   cgc_left,                       sizeof(cgc_left) - 1,                        &iObj_set_left,                         &iObj_get_left                          },
		{   cgc_memberClass,                sizeof(cgc_memberClass) - 1,                 &iObj_set_memberClass,                  &iObj_get_memberClass                   },
		{   cgc_memberClassLibrary,         sizeof(cgc_memberClassLibrary) - 1,          &iObj_set_memberClassLibrary,           &iObj_get_memberClassLibrary            },
		{   cgc_mouseIcon,                  sizeof(cgc_mouseIcon) - 1,                   &iObj_set_mouseIcon,                    &iObj_get_mouseIcon                     },
		{   cgc_mousePointer,               sizeof(cgc_mousePointer) - 1,                &iObj_set_mousePointer,                 &iObj_get_mousePointer                  },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_oLEDragMode,                sizeof(cgc_oLEDragMode) - 1,                 &iObj_set_oLEDragMode,                  &iObj_get_oLEDragMode                   },
	...
	SPropertyMap gcProps_label[] = 
	{
		...
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_rightToLeft,                sizeof(cgc_rightToLeft) - 1,                 &iObj_set_rightToLeft,                  &iObj_get_rightToLeft                   },
		{   cgc_rotation,                   sizeof(cgc_rotation) - 1,                    &iObj_set_rotation,                     &iObj_get_rotation                      },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
		{   cgc_style,                      sizeof(cgc_style) - 1,                       &iObj_set_style,                        &iObj_get_style                         },
		{   cgc_tabIndex,                   sizeof(cgc_tabIndex) - 1,                    &iObj_set_tabIndex,                     &iObj_get_tabIndex                      },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
	...
	SPropertyMap gcProps_textbox[] = 
	{
		...
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_autoComplete,               sizeof(cgc_autoComplete) - 1,                &iObj_set_autoComplete,                 &iObj_get_autoComplete                  },
		{   cgc_autoCompTable,              sizeof(cgc_autoCompTable) - 1,               &iObj_set_autoCompTable,                &iObj_get_autoCompTable                 },
		{   cgc_autoCompSource,             sizeof(cgc_autoCompSource) - 1,              &iObj_set_autoCompSource,               &iObj_get_autoCompSource                },
		{   cgc_backStyle,                  sizeof(cgc_backStyle) - 1,                   &iObj_set_backStyle,                    &iObj_get_backStyle                     },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_borderColor,                sizeof(cgc_borderColor) - 1,                 &iObj_set_borderColor,                  &iObj_get_borderColor                   },
		{   cgc_borderStyle,                sizeof(cgc_borderStyle) - 1,                 &iObj_set_borderStyle,                  &iObj_get_borderStyle                   },
		{   cgc_century,                    sizeof(cgc_century) - 1,                     &iObj_set_century,                      &iObj_get_century                       },
		{   cgc_colorScheme,                sizeof(cgc_colorScheme) - 1,                 &iObj_set_colorScheme,                  &iObj_get_colorScheme                   },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		{   cgc_foreColor,                  sizeof(cgc_foreColor) - 1,                   &iObj_set_foreColor,                    &iObj_get_foreColor                     },
		{   cgc_backColor,                  sizeof(cgc_backColor) - 1,                   &iObj_set_backColor,                    &iObj_get_backColor                     },
		...
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_controlSource,              sizeof(cgc_controlSource) - 1,               &iObj_set_controlSource,                &iObj_get_controlSource                 },
		{   cgc_dateFormat,                 sizeof(cgc_dateFormat) - 1,                  &iObj_set_dateFormat,                   &iObj_get_dateFormat                    },
		{   cgc_dateMark,                   sizeof(cgc_dateMark) - 1,                    &iObj_set_dateMark,                     &iObj_get_dateMark                      },
		{   cgc_dragIcon,                   sizeof(cgc_dragIcon) - 1,                    &iObj_set_dragIcon,                     &iObj_get_dragIcon                      },
		{   cgc_dragMode,                   sizeof(cgc_dragMode) - 1,                    &iObj_set_dragMode,                     &iObj_get_dragMode                      },
		{   cgc_enabled,                    sizeof(cgc_enabled) - 1,                     &iObj_set_enabled,                      &iObj_get_enabled                       },
		{   cgc_enableHyperlinks,           sizeof(cgc_enableHyperlinks) - 1,            &iObj_set_enableHyperlinks,             &iObj_get_enableHyperlinks              },
		{   cgc_fontBold,                   sizeof(cgc_fontBold) - 1,                    &iObj_set_fontBold,                     &iObj_get_fontBold                      },
		{   cgc_fontCharSet,                sizeof(cgc_fontCharSet) - 1,                 &iObj_set_fontCharSet,                  &iObj_get_fontCharSet                   },
		{   cgc_fontCondense,               sizeof(cgc_fontCondense) - 1,                &iObj_set_fontCondense,                 &iObj_get_fontCondense                  },
		{   cgc_fontExtend,                 sizeof(cgc_fontExtend) - 1,                  &iObj_set_fontExtend,                   &iObj_get_fontExtend                    },
		...
		{   cgc_fontStrikeThru,             sizeof(cgc_fontStrikeThru) - 1,              &iObj_set_fontStrikeThru,               &iObj_get_fontStrikeThru                },
		{   cgc_fontUnderline,              sizeof(cgc_fontUnderline) - 1,               &iObj_set_fontUnderline,                &iObj_get_fontUnderline                 },
		{   cgc_format,                     sizeof(cgc_format) - 1,                      &iObj_set_format,                       &iObj_get_format                        },
		{   cgc_height,                     sizeof(cgc_height) - 1,                      &iObj_set_height,                       &iObj_get_height                        },
		{   cgc_helpContextID,              sizeof(cgc_helpContextID) - 1,               &iObj_set_helpContextID,                &iObj_get_helpContextID                 },
		{   cgc_hideSelection,              sizeof(cgc_hideSelection) - 1,               &iObj_set_hideSelection,                &iObj_get_hideSelection                 },
		{   cgc_hours,                      sizeof(cgc_hours) - 1,                       &iObj_set_hours,                        &iObj_get_hours                         },
		{   cgc_iMEMode,                    sizeof(cgc_iMEMode) - 1,                     &iObj_set_iMEMode,                      &iObj_get_iMEMode                       },
		{   cgc_inputMask,                  sizeof(cgc_inputMask) - 1,                   &iObj_set_inputMask,                    &iObj_get_inputMask                     },
		{   cgc_integralHeight,             sizeof(cgc_integralHeight) - 1,              &iObj_set_integralHeight,               &iObj_get_integralHeight                },
		{   cgc_left,                       sizeof(cgc_left) - 1,                        &iObj_set_left,                         &iObj_get_left                          },
		{   cgc_margin,                     sizeof(cgc_margin) - 1,                      &iObj_set_margin,                       &iObj_get_margin                        },
		{   cgc_maxLength,                  sizeof(cgc_maxLength) - 1,                   &iObj_set_maxLength,                    &iObj_get_maxLength                     },
		{   cgc_mouseIcon,                  sizeof(cgc_mouseIcon) - 1,                   &iObj_set_mouseIcon,                    &iObj_get_mouseIcon                     },
		{   cgc_mousePointer,               sizeof(cgc_mousePointer) - 1,                &iObj_set_mousePointer,                 &iObj_get_mousePointer                  },
		{   cgc_memoWindow,                 sizeof(cgc_memoWindow) - 1,                  &iObj_set_memoWindow,                   &iObj_get_memoWindow                    },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_nullDisplay,                sizeof(cgc_nullDisplay) - 1,                 &iObj_set_nullDisplay,                  &iObj_get_nullDisplay                   },
		{   cgc_oLEDragMode,                sizeof(cgc_oLEDragMode) - 1,                 &iObj_set_oLEDragMode,                  &iObj_get_oLEDragMode                   },
		{   cgc_oLEDragPicture,             sizeof(cgc_oLEDragPicture) - 1,              &iObj_set_oLEDragPicture,               &iObj_get_oLEDragPicture                },
		{   cgc_oLEDropEffects,             sizeof(cgc_oLEDropEffects) - 1,              &iObj_set_oLEDropEffects,               &iObj_get_oLEDropEffects                },
		{   cgc_oLEDropHasData,             sizeof(cgc_oLEDropHasData) - 1,              &iObj_set_oLEDropHasData,               &iObj_get_oLEDropHasData                },
		{   cgc_oLEDropMode,                sizeof(cgc_oLEDropMode) - 1,                 &iObj_set_oLEDropMode,                  &iObj_get_oLEDropMode                   },
		{   cgc_oLEDropTextInsertion,       sizeof(cgc_oLEDropTextInsertion) - 1,        &iObj_set_oLEDropTextInsertion,         &iObj_get_oLEDropTextInsertion          },
		{   cgc_openWindow,                 sizeof(cgc_openWindow) - 1,                  &iObj_set_openWindow,                   &iObj_get_openWindow                    },
		{   cgc_parent,                     sizeof(cgc_parent) - 1,                      &iObj_set_parent,                       &iObj_get_parent                        },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_passwordChar,               sizeof(cgc_passwordChar) - 1,                &iObj_set_passwordChar,                 &iObj_get_passwordChar                  },
		{   cgc_readOnly,                   sizeof(cgc_readOnly) - 1,                    &iObj_set_readOnly,                     &iObj_get_readOnly                      },
		{   cgc_rightToLeft,                sizeof(cgc_rightToLeft) - 1,                 &iObj_set_rightToLeft,                  &iObj_get_rightToLeft                   },
		{   cgc_seconds,                    sizeof(cgc_seconds) - 1,                     &iObj_set_seconds,                      &iObj_get_seconds                       },
		{   cgc_selectedBackColor,          sizeof(cgc_selectedBackColor) - 1,           &iObj_set_selectedBackColor,            &iObj_get_selectedBackColor             },
		{   cgc_selectedForeColor,          sizeof(cgc_selectedForeColor) - 1,           &iObj_set_selectedForeColor,            &iObj_get_selectedForeColor             },
		{   cgc_selectOnEntry,              sizeof(cgc_selectOnEntry) - 1,               &iObj_set_selectOnEntry,                &iObj_get_selectOnEntry                 },
		{   cgc_selLength,                  sizeof(cgc_selLength) - 1,                   &iObj_set_selLength,                    &iObj_get_selLength                     },
		{   cgc_selStart,                   sizeof(cgc_selStart) - 1,                    &iObj_set_selStart,                     &iObj_get_selStart                      },
		{   cgc_selText,                    sizeof(cgc_selText) - 1,                     &iObj_set_selText,                      &iObj_get_selText                       },
		{   cgc_specialEffect,              sizeof(cgc_specialEffect) - 1,               &iObj_set_specialEffect,                &iObj_get_specialEffect                 },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
		{   cgc_strictDateEntry,            sizeof(cgc_strictDateEntry) - 1,             &iObj_set_strictDateEntry,              &iObj_get_strictDateEntry               },
		{   cgc_style,                      sizeof(cgc_style) - 1,                       &iObj_set_style,                        &iObj_get_style                         },
		{   cgc_tabIndex,                   sizeof(cgc_tabIndex) - 1,                    &iObj_set_tabIndex,                     &iObj_get_tabIndex                      },
		{   cgc_tabStop,                    sizeof(cgc_tabStop) - 1,                     &iObj_set_tabStop,                      &iObj_get_tabStop                       },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_terminateRead,              sizeof(cgc_terminateRead) - 1,               &iObj_set_terminateRead,                &iObj_get_terminateRead                 },
		{   cgc_text,                       sizeof(cgc_text) - 1,                        &iObj_set_text,                         &iObj_get_text                          },
		{   cgc_themes,                     sizeof(cgc_themes) - 1,                      &iObj_set_themes,                       &iObj_get_themes                        },
		{   cgc_toolTipText,                sizeof(cgc_toolTipText) - 1,                 &iObj_set_toolTipText,                  &iObj_get_toolTipText                   },
		{   cgc_top,                        sizeof(cgc_top) - 1,                         &iObj_set_top,                          &iObj_get_top                           },
		{   cgc_value,                      sizeof(cgc_value) - 1,                       &iObj_set_value,                        &iObj_get_value                         },
	...
	{
		{   cgc_addLineFeeds,               sizeof(cgc_addLineFeeds) - 1,                &iObj_set_addLineFeeds,                 &iObj_get_addLineFeeds                  },
		{   cgc_alignment,                  sizeof(cgc_alignment) - 1,                   &iObj_set_alignment,                    &iObj_get_alignment                     },
		{   cgc_allowTabs,                  sizeof(cgc_allowTabs) - 1,                   &iObj_set_allowTabs,                    &iObj_get_allowTabs                     },
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_backStyle,                  sizeof(cgc_backStyle) - 1,                   &iObj_set_backStyle,                    &iObj_get_backStyle                     },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		...
		{   cgc_readOnly,                   sizeof(cgc_readOnly) - 1,                    &iObj_set_readOnly,                     &iObj_get_readOnly                      },
		{   cgc_rightToLeft,                sizeof(cgc_rightToLeft) - 1,                 &iObj_set_rightToLeft,                  &iObj_get_rightToLeft                   },
		{   cgc_scrollBars,                 sizeof(cgc_scrollBars) - 1,                  &iObj_set_scrollBars,                   &iObj_get_scrollBars                    },
		{   cgc_selectedBackColor,          sizeof(cgc_selectedBackColor) - 1,           &iObj_set_selectedBackColor,            &iObj_get_selectedBackColor             },
		{   cgc_selectedForeColor,          sizeof(cgc_selectedForeColor) - 1,           &iObj_set_selectedForeColor,            &iObj_get_selectedForeColor             },
		{   cgc_selectOnEntry,              sizeof(cgc_selectOnEntry) - 1,               &iObj_set_selectOnEntry,                &iObj_get_selectOnEntry                 },
		{   cgc_selLength,                  sizeof(cgc_selLength) - 1,                   &iObj_set_selLength,                    &iObj_get_selLength                     },
	...
	SPropertyMap gcProps_listbox[] = 
	{
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_autoHideScrollBar,          sizeof(cgc_autoHideScrollBar) - 1,           &iObj_set_autoHideScrollBar,            &iObj_get_autoHideScrollBar             },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_listCount,                  sizeof(cgc_listCount) - 1,                   &iObj_set_listCount,                    &iObj_get_listCount                     },
		{   cgc_columnCount,                sizeof(cgc_columnCount) - 1,                 &iObj_set_columnCount,                  &iObj_get_columnCount                   },
		{   cgc_borderColor,                sizeof(cgc_borderColor) - 1,                 &iObj_set_borderColor,                  &iObj_get_borderColor                   },
		{   cgc_boundColumn,                sizeof(cgc_boundColumn) - 1,                 &iObj_set_boundColumn,                  &iObj_get_boundColumn                   },
		{   cgc_boundTo,                    sizeof(cgc_boundTo) - 1,                     &iObj_set_boundTo,                      &iObj_get_boundTo                       },
		{   cgc_colorScheme,                sizeof(cgc_colorScheme) - 1,                 &iObj_set_colorScheme,                  &iObj_get_colorScheme                   },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		{   cgc_disabledBackColor,          sizeof(cgc_disabledBackColor) - 1,           &iObj_set_disabledBackColor,            &iObj_get_disabledBackColor             },
		{   cgc_disabledForeColor,          sizeof(cgc_disabledForeColor) - 1,           &iObj_set_disabledForeColor,            &iObj_get_disabledForeColor             },
		{   cgc_disabledItemBackColor,      sizeof(cgc_disabledItemBackColor) - 1,       &iObj_set_disabledItemBackColor,        &iObj_get_disabledItemBackColor         },
		{   cgc_disabledItemForeColor,      sizeof(cgc_disabledItemForeColor) - 1,       &iObj_set_disabledItemForeColor,        &iObj_get_disabledItemForeColor         },
		{   cgc_columnLines,                sizeof(cgc_columnLines) - 1,                 &iObj_set_columnLines,                  &iObj_get_columnLines                   },
		{   cgc_columnWidths,               sizeof(cgc_columnWidths) - 1,                &iObj_set_columnWidths,                 &iObj_get_columnWidths                  },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_controlSource,              sizeof(cgc_controlSource) - 1,               &iObj_set_controlSource,                &iObj_get_controlSource                 },
		{   cgc_rowSource,                  sizeof(cgc_rowSource) - 1,                   &iObj_set_rowSource,                    &iObj_get_rowSource                     },
		{   cgc_rowSourceType,              sizeof(cgc_rowSourceType) - 1,               &iObj_set_rowSourceType,                &iObj_get_rowSourceType                 },
		{   cgc_displayValue,               sizeof(cgc_displayValue) - 1,                &iObj_set_displayValue,                 &iObj_get_displayValue                  },
		{   cgc_dragIcon,                   sizeof(cgc_dragIcon) - 1,                    &iObj_set_dragIcon,                     &iObj_get_dragIcon                      },
		{   cgc_dragMode,                   sizeof(cgc_dragMode) - 1,                    &iObj_set_dragMode,                     &iObj_get_dragMode                      },
		{   cgc_enabled,                    sizeof(cgc_enabled) - 1,                     &iObj_set_enabled,                      &iObj_get_enabled                       },
		{   cgc_firstElement,               sizeof(cgc_firstElement) - 1,                &iObj_set_firstElement,                 &iObj_get_firstElement                  },
		{   cgc_fontBold,                   sizeof(cgc_fontBold) - 1,                    &iObj_set_fontBold,                     &iObj_get_fontBold                      },
		{   cgc_fontCharSet,                sizeof(cgc_fontCharSet) - 1,                 &iObj_set_fontCharSet,                  &iObj_get_fontCharSet                   },
		{   cgc_fontCondense,               sizeof(cgc_fontCondense) - 1,                &iObj_set_fontCondense,                 &iObj_get_fontCondense                  },
		{   cgc_fontExtend,                 sizeof(cgc_fontExtend) - 1,                  &iObj_set_fontExtend,                   &iObj_get_fontExtend                    },
		...
		{   cgc_height,                     sizeof(cgc_height) - 1,                      &iObj_set_height,                       &iObj_get_height                        },
		{   cgc_helpContextID,              sizeof(cgc_helpContextID) - 1,               &iObj_set_helpContextID,                &iObj_get_helpContextID                 },
		{   cgc_incrementalSearch,          sizeof(cgc_incrementalSearch) - 1,           &iObj_set_incrementalSearch,            &iObj_get_incrementalSearch             },
		{   cgc_integralHeight,             sizeof(cgc_integralHeight) - 1,              &iObj_set_integralHeight,               &iObj_get_integralHeight                },
		{   cgc_itemBackColor,              sizeof(cgc_itemBackColor) - 1,               &iObj_set_itemBackColor,                &iObj_get_itemBackColor                 },
		{   cgc_itemForeColor,              sizeof(cgc_itemForeColor) - 1,               &iObj_set_itemForeColor,                &iObj_get_itemForeColor                 },
		{   cgc_itemData,                   sizeof(cgc_itemData) - 1,                    &iObj_set_itemData,                     &iObj_get_itemData                      },
		{   cgc_itemIDData,                 sizeof(cgc_itemIDData) - 1,                  &iObj_set_itemIDData,                   &iObj_get_itemIDData                    },
		{   cgc_itemTips,                   sizeof(cgc_itemTips) - 1,                    &iObj_set_itemTips,                     &iObj_get_itemTips                      },
		{   cgc_left,                       sizeof(cgc_left) - 1,                        &iObj_set_left,                         &iObj_get_left                          },
		{   cgc_list,                       sizeof(cgc_list) - 1,                        &iObj_set_list,                         &iObj_get_list                          },
		{   cgc_listIndex,                  sizeof(cgc_listIndex) - 1,                   &iObj_set_listIndex,                    &iObj_get_listIndex                     },
		{   cgc_listItem,                   sizeof(cgc_listItem) - 1,                    &iObj_set_listItem,                     &iObj_get_listItem                      },
		{   cgc_listItemID,                 sizeof(cgc_listItemID) - 1,                  &iObj_set_listItemID,                   &iObj_get_listItemID                    },
		{   cgc_mouseIcon,                  sizeof(cgc_mouseIcon) - 1,                   &iObj_set_mouseIcon,                    &iObj_get_mouseIcon                     },
		{   cgc_mousePointer,               sizeof(cgc_mousePointer) - 1,                &iObj_set_mousePointer,                 &iObj_get_mousePointer                  },
		{   cgc_moverBars,                  sizeof(cgc_moverBars) - 1,                   &iObj_set_moverBars,                    &iObj_get_moverBars                     },
		{   cgc_multiSelect,                sizeof(cgc_multiSelect) - 1,                 &iObj_set_multiSelect,                  &iObj_get_multiSelect                   },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_newIndex,                   sizeof(cgc_newIndex) - 1,                    &iObj_set_newIndex,                     &iObj_get_newIndex                      },
		{   cgc_newItemID,                  sizeof(cgc_newItemID) - 1,                   &iObj_set_newItemID,                    &iObj_get_newItemID                     },
		{   cgc_nullDisplay,                sizeof(cgc_nullDisplay) - 1,                 &iObj_set_nullDisplay,                  &iObj_get_nullDisplay                   },
		{   cgc_numberOfElements,           sizeof(cgc_numberOfElements) - 1,            &iObj_set_numberOfElements,             &iObj_get_numberOfElements              },
		{   cgc_oLEDragMode,                sizeof(cgc_oLEDragMode) - 1,                 &iObj_set_oLEDragMode,                  &iObj_get_oLEDragMode                   },
		{   cgc_oLEDragPicture,             sizeof(cgc_oLEDragPicture) - 1,              &iObj_set_oLEDragPicture,               &iObj_get_oLEDragPicture                },
		{   cgc_oLEDropEffects,             sizeof(cgc_oLEDropEffects) - 1,              &iObj_set_oLEDropEffects,               &iObj_get_oLEDropEffects                },
		{   cgc_oLEDropHasData,             sizeof(cgc_oLEDropHasData) - 1,              &iObj_set_oLEDropHasData,               &iObj_get_oLEDropHasData                },
		...
		{   cgc_picture,                    sizeof(cgc_picture) - 1,                     &iObj_set_picture,                      &iObj_get_picture                       },
		{   cgc_rightToLeft,                sizeof(cgc_rightToLeft) - 1,                 &iObj_set_rightToLeft,                  &iObj_get_rightToLeft                   },
		{   cgc_selected,                   sizeof(cgc_selected) - 1,                    &iObj_set_selected,                     &iObj_get_selected                      },
		{   cgc_selectedID,                 sizeof(cgc_selectedID) - 1,                  &iObj_set_selectedID,                   &iObj_get_selectedID                    },
		{   cgc_selectedItemBackColor,      sizeof(cgc_selectedItemBackColor) - 1,       &iObj_set_selectedItemBackColor,        &iObj_get_selectedItemBackColor         },
		{   cgc_selectedItemForeColor,      sizeof(cgc_selectedItemForeColor) - 1,       &iObj_set_selectedItemForeColor,        &iObj_get_selectedItemForeColor         },
		{   cgc_sorted,                     sizeof(cgc_sorted) - 1,                      &iObj_set_sorted,                       &iObj_get_sorted                        },
		{   cgc_specialEffect,              sizeof(cgc_specialEffect) - 1,               &iObj_set_specialEffect,                &iObj_get_specialEffect                 },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
		{   cgc_tabIndex,                   sizeof(cgc_tabIndex) - 1,                    &iObj_set_tabIndex,                     &iObj_get_tabIndex                      },
		{   cgc_tabStop,                    sizeof(cgc_tabStop) - 1,                     &iObj_set_tabStop,                      &iObj_get_tabStop                       },
		...
		{   cgc_toolTipText,                sizeof(cgc_toolTipText) - 1,                 &iObj_set_toolTipText,                  &iObj_get_toolTipText                   },
		{   cgc_top,                        sizeof(cgc_top) - 1,                         &iObj_set_top,                          &iObj_get_top                           },
		{   cgc_topIndex,                   sizeof(cgc_topIndex) - 1,                    &iObj_set_topIndex,                     &iObj_get_topIndex                      },
		{   cgc_topItemID,                  sizeof(cgc_topItemID) - 1,                   &iObj_set_topItemID,                    &iObj_get_topItemID                     },
		{   cgc_value,                      sizeof(cgc_value) - 1,                       &iObj_set_value,                        &iObj_get_value                         },
		{   cgc_visible,                    sizeof(cgc_visible) - 1,                     &iObj_set_visible,                      &iObj_get_visible                       },
		{   cgc_whatsThisHelpID,            sizeof(cgc_whatsThisHelpID) - 1,             &iObj_set_whatsThisHelpID,              &iObj_get_whatsThisHelpID               },
		{   cgc_width,                      sizeof(cgc_width) - 1,                       &iObj_set_width,                        &iObj_get_width                         },
	...
	SPropertyMap gcProps_combobox[] = 
	{
		...
		{   cgc_rowSource,                  sizeof(cgc_rowSource) - 1,                   &iObj_set_rowSource,                    &iObj_get_rowSource                     },
		{   cgc_rowSourceType,              sizeof(cgc_rowSourceType) - 1,               &iObj_set_rowSourceType,                &iObj_get_rowSourceType                 },
		{   cgc_displayCount,               sizeof(cgc_displayCount) - 1,                &iObj_set_displayCount,                 &iObj_get_displayCount                  },
		{   cgc_displayValue,               sizeof(cgc_displayValue) - 1,                &iObj_set_displayValue,                 &iObj_get_displayValue                  },
		{   cgc_dragIcon,                   sizeof(cgc_dragIcon) - 1,                    &iObj_set_dragIcon,                     &iObj_get_dragIcon                      },
		{   cgc_dragMode,                   sizeof(cgc_dragMode) - 1,                    &iObj_set_dragMode,                     &iObj_get_dragMode                      },
		{   cgc_enabled,                    sizeof(cgc_enabled) - 1,                     &iObj_set_enabled,                      &iObj_get_enabled                       },
		...
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_picture,                    sizeof(cgc_picture) - 1,                     &iObj_set_picture,                      &iObj_get_picture                       },
		{   cgc_pictureSelectionDisplay,    sizeof(cgc_pictureSelectionDisplay) - 1,     &iObj_set_pictureSelectionDisplay,      &iObj_get_pictureSelectionDisplay       },
		{   cgc_readOnly,                   sizeof(cgc_readOnly) - 1,                    &iObj_set_readOnly,                     &iObj_get_readOnly                      },
		{   cgc_rightToLeft,                sizeof(cgc_rightToLeft) - 1,                 &iObj_set_rightToLeft,                  &iObj_get_rightToLeft                   },
		{   cgc_selected,                   sizeof(cgc_selected) - 1,                    &iObj_set_selected,                     &iObj_get_selected                      },
		{   cgc_selectedID,                 sizeof(cgc_selectedID) - 1,                  &iObj_set_selectedID,                   &iObj_get_selectedID                    },
	...
	{
		{   cgc_activeControl,              sizeof(cgc_activeControl) - 1,               &iObj_set_activeControl,                &iObj_get_activeControl                 },
		{   cgc_activeForm,                 sizeof(cgc_activeForm) - 1,                  &iObj_set_activeForm,                   &iObj_get_activeForm                    },
		{   cgc_allowOutput,                sizeof(cgc_allowOutput) - 1,                 &iObj_set_allowOutput,                  &iObj_get_allowOutput                   },
		{   cgc_alwaysOnTop,                sizeof(cgc_alwaysOnTop) - 1,                 &iObj_set_alwaysOnTop,                  &iObj_get_alwaysOnTop                   },
		{   cgc_alwaysOnBottom,             sizeof(cgc_alwaysOnBottom) - 1,              &iObj_set_alwaysOnBottom,               &iObj_get_alwaysOnBottom                },
		{   cgc_bindControls,               sizeof(cgc_bindControls) - 1,                &iObj_set_bindControls,                 &iObj_get_bindControls                  },
		{   cgc_bufferMode,                 sizeof(cgc_bufferMode) - 1,                  &iObj_set_bufferMode,                   &iObj_get_bufferMode                    },
		{   cgc_controlBox,                 sizeof(cgc_controlBox) - 1,                  &iObj_set_controlBox,                   &iObj_get_controlBox                    },
		{   cgc_closable,                   sizeof(cgc_closable) - 1,                    &iObj_set_closable,                     &iObj_get_closable                      },
		{   cgc_continuousScroll,           sizeof(cgc_continuousScroll) - 1,            &iObj_set_continuousScroll,             &iObj_get_continuousScroll              },
		{   cgc_dataSession,                sizeof(cgc_dataSession) - 1,                 &iObj_set_dataSession,                  &iObj_get_dataSession                   },
		{   cgc_dataSessionID,              sizeof(cgc_dataSessionID) - 1,               &iObj_set_dataSessionID,                &iObj_get_dataSessionID                 },
		{   cgc_dataEnvironment,            sizeof(cgc_dataEnvironment) - 1,             &iObj_set_dataEnvironment,              &iObj_get_dataEnvironment               },
		{   cgc_dEClass,                    sizeof(cgc_dEClass) - 1,                     &iObj_set_dEClass,                      &iObj_get_dEClass                       },
		{   cgc_dEClassLibrary,             sizeof(cgc_dEClassLibrary) - 1,              &iObj_set_dEClassLibrary,               &iObj_get_dEClassLibrary                },
		{   cgc_defOLELCID,                 sizeof(cgc_defOLELCID) - 1,                  &iObj_set_defOLELCID,                   &iObj_get_defOLELCID                    },
		{   cgc_desktop,                    sizeof(cgc_desktop) - 1,                     &iObj_set_desktop,                      &iObj_get_desktop                       },
		{   cgc_macDesktop,                 sizeof(cgc_macDesktop) - 1,                  &iObj_set_macDesktop,                   &iObj_get_macDesktop                    },
		{   cgc_dockPosition,               sizeof(cgc_dockPosition) - 1,                &iObj_set_dockPosition,                 &iObj_get_dockPosition                  },
		{   cgc_dockable,                   sizeof(cgc_dockable) - 1,                    &iObj_set_dockable,                     &iObj_get_dockable                      },
		{   cgc_docked,                     sizeof(cgc_docked) - 1,                      &iObj_set_docked,                       &iObj_get_docked                        },
		{   cgc_mDIForm,                    sizeof(cgc_mDIForm) - 1,                     &iObj_set_mDIForm,                      &iObj_get_mDIForm                       },
		{   cgc_doCreate,                   sizeof(cgc_doCreate) - 1,                    &iObj_set_doCreate,                     &iObj_get_doCreate                      },
		{   cgc_fillColor,                  sizeof(cgc_fillColor) - 1,                   &iObj_set_fillColor,                    &iObj_get_fillColor                     },
		{   cgc_fillStyle,                  sizeof(cgc_fillStyle) - 1,                   &iObj_set_fillStyle,                    &iObj_get_fillStyle                     },
		{   cgc_hScrollSmallChange,         sizeof(cgc_hScrollSmallChange) - 1,          &iObj_set_hScrollSmallChange,           &iObj_get_hScrollSmallChange            },
		{   cgc_vScrollSmallChange,         sizeof(cgc_vScrollSmallChange) - 1,          &iObj_set_vScrollSmallChange,           &iObj_get_vScrollSmallChange            },
		{   cgc_lockScreen,                 sizeof(cgc_lockScreen) - 1,                  &iObj_set_lockScreen,                   &iObj_get_lockScreen                    },
		{   cgc_maxButton,                  sizeof(cgc_maxButton) - 1,                   &iObj_set_maxButton,                    &iObj_get_maxButton                     },
		{   cgc_minButton,                  sizeof(cgc_minButton) - 1,                   &iObj_set_minButton,                    &iObj_get_minButton                     },
		{   cgc_movable,                    sizeof(cgc_movable) - 1,                     &iObj_set_movable,                      &iObj_get_movable                       },
		{   cgc_maxHeight,                  sizeof(cgc_maxHeight) - 1,                   &iObj_set_maxHeight,                    &iObj_get_maxHeight                     },
		{   cgc_maxWidth,                   sizeof(cgc_maxWidth) - 1,                    &iObj_set_maxWidth,                     &iObj_get_maxWidth                      },
		{   cgc_maxTop,                     sizeof(cgc_maxTop) - 1,                      &iObj_set_maxTop,                       &iObj_get_maxTop                        },
		{   cgc_maxLeft,                    sizeof(cgc_maxLeft) - 1,                     &iObj_set_maxLeft,                      &iObj_get_maxLeft                       },
		{   cgc_minHeight,                  sizeof(cgc_minHeight) - 1,                   &iObj_set_minHeight,                    &iObj_get_minHeight                     },
		{   cgc_minWidth,                   sizeof(cgc_minWidth) - 1,                    &iObj_set_minWidth,                     &iObj_get_minWidth                      },
		{   cgc_scaleMode,                  sizeof(cgc_scaleMode) - 1,                   &iObj_set_scaleMode,                    &iObj_get_scaleMode                     },
		{   cgc_showTips,                   sizeof(cgc_showTips) - 1,                    &iObj_set_showTips,                     &iObj_get_showTips                      },
		{   cgc_showWindow,                 sizeof(cgc_showWindow) - 1,                  &iObj_set_showWindow,                   &iObj_get_showWindow                    },
		{   cgc_showInTaskbar,              sizeof(cgc_showInTaskbar) - 1,               &iObj_set_showInTaskbar,                &iObj_get_showInTaskbar                 },
		{   cgc_sizeBox,                    sizeof(cgc_sizeBox) - 1,                     &iObj_set_sizeBox,                      &iObj_get_sizeBox                       },
		{   cgc_windowType,                 sizeof(cgc_windowType) - 1,                  &iObj_set_windowType,                   &iObj_get_windowType                    },
		{   cgc_windowState,                sizeof(cgc_windowState) - 1,                 &iObj_set_windowState,                  &iObj_get_windowState                   },
		{   cgc_autoCenter,                 sizeof(cgc_autoCenter) - 1,                  &iObj_set_autoCenter,                   &iObj_get_autoCenter                    },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_controls,                   sizeof(cgc_controls) - 1,                    &iObj_set_controls,                     &iObj_get_controls                      },
		...
		{   cgc_objects,                    sizeof(cgc_objects) - 1,                     &iObj_set_objects,                      &iObj_get_objects                       },
		{   cgc_borderStyle,                sizeof(cgc_borderStyle) - 1,                 &iObj_set_borderStyle,                  &iObj_get_borderStyle                   },
		{   cgc_clipControls,               sizeof(cgc_clipControls) - 1,                &iObj_set_clipControls,                 &iObj_get_clipControls                  },
		{   cgc_caption,                    sizeof(cgc_caption) - 1,                     &iObj_set_caption,                      &iObj_get_caption                       },
		{   cgc_halfHeightCaption,          sizeof(cgc_halfHeightCaption) - 1,           &iObj_set_halfHeightCaption,            &iObj_get_halfHeightCaption             },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		{   cgc_foreColor,                  sizeof(cgc_foreColor) - 1,                   &iObj_set_foreColor,                    &iObj_get_foreColor                     },
		{   cgc_backColor,                  sizeof(cgc_backColor) - 1,                   &iObj_set_backColor,                    &iObj_get_backColor                     },
		{   cgc_currentX,                   sizeof(cgc_currentX) - 1,                    &iObj_set_currentX,                     &iObj_get_currentX                      },
		{   cgc_currentY,                   sizeof(cgc_currentY) - 1,                    &iObj_set_currentY,                     &iObj_get_currentY                      },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_drawMode,                   sizeof(cgc_drawMode) - 1,                    &iObj_set_drawMode,                     &iObj_get_drawMode                      },
		{   cgc_drawStyle,                  sizeof(cgc_drawStyle) - 1,                   &iObj_set_drawStyle,                    &iObj_get_drawStyle                     },
		{   cgc_drawWidth,                  sizeof(cgc_drawWidth) - 1,                   &iObj_set_drawWidth,                    &iObj_get_drawWidth                     },
		{   cgc_enabled,                    sizeof(cgc_enabled) - 1,                     &iObj_set_enabled,                      &iObj_get_enabled                       },
		{   cgc_fontBold,                   sizeof(cgc_fontBold) - 1,                    &iObj_set_fontBold,                     &iObj_get_fontBold                      },
		{   cgc_fontCharSet,                sizeof(cgc_fontCharSet) - 1,                 &iObj_set_fontCharSet,                  &iObj_get_fontCharSet                   },
		{   cgc_fontCondense,               sizeof(cgc_fontCondense) - 1,                &iObj_set_fontCondense,                 &iObj_get_fontCondense                  },
		...
		{   cgc_icon,                       sizeof(cgc_icon) - 1,                        &iObj_set_icon,                         &iObj_get_icon                          },
		{   cgc_picture,                    sizeof(cgc_picture) - 1,                     &iObj_set_picture,                      &iObj_get_picture                       },
		{   cgc_releaseType,                sizeof(cgc_releaseType) - 1,                 &iObj_set_releaseType,                  &iObj_get_releaseType                   },
		{   cgc_rightToLeft,                sizeof(cgc_rightToLeft) - 1,                 &iObj_set_rightToLeft,                  &iObj_get_rightToLeft                   },
		{   cgc_scrollBars,                 sizeof(cgc_scrollBars) - 1,                  &iObj_set_scrollBars,                   &iObj_get_scrollBars                    },
		{   cgc_tabIndex,                   sizeof(cgc_tabIndex) - 1,                    &iObj_set_tabIndex,                     &iObj_get_tabIndex                      },
		{   cgc_tabStop,                    sizeof(cgc_tabStop) - 1,                     &iObj_set_tabStop,                      &iObj_get_tabStop                       },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_themes,                     sizeof(cgc_themes) - 1,                      &iObj_set_themes,                       &iObj_get_themes                        },
		{   cgc_titleBar,                   sizeof(cgc_titleBar) - 1,                    &iObj_set_titleBar,                     &iObj_get_titleBar                      },
		{   cgc_top,                        sizeof(cgc_top) - 1,                         &iObj_set_top,                          &iObj_get_top                           },
		{   cgc_visible,                    sizeof(cgc_visible) - 1,                     &iObj_set_visible,                      &iObj_get_visible                       },
		{   cgc_viewPortHeight,             sizeof(cgc_viewPortHeight) - 1,              &iObj_set_viewPortHeight,               &iObj_get_viewPortHeight                },
		{   cgc_viewPortLeft,               sizeof(cgc_viewPortLeft) - 1,                &iObj_set_viewPortLeft,                 &iObj_get_viewPortLeft                  },
		{   cgc_viewPortTop,                sizeof(cgc_viewPortTop) - 1,                 &iObj_set_viewPortTop,                  &iObj_get_viewPortTop                   },
		{   cgc_viewPortWidth,              sizeof(cgc_viewPortWidth) - 1,               &iObj_set_viewPortWidth,                &iObj_get_viewPortWidth                 },
		{   cgc_whatsThisHelpID,            sizeof(cgc_whatsThisHelpID) - 1,             &iObj_set_whatsThisHelpID,              &iObj_get_whatsThisHelpID               },
		{   cgc_whatsThisHelp,              sizeof(cgc_whatsThisHelp) - 1,               &iObj_set_whatsThisHelp,                &iObj_get_whatsThisHelp                 },
		{   cgc_whatsThisButton,            sizeof(cgc_whatsThisButton) - 1,             &iObj_set_whatsThisButton,              &iObj_get_whatsThisButton               },
		{   cgc_width,                      sizeof(cgc_width) - 1,                       &iObj_set_width,                        &iObj_get_width                         },
		{   cgc_zoomBox,                    sizeof(cgc_zoomBox) - 1,                     &iObj_set_zoomBox,                      &iObj_get_zoomBox                       },
		{   NULL,                           0,                                           0,                                      0                                       }
	};
	...
	{
		{   cgc_activeForm,                 sizeof(cgc_activeForm) - 1,                  &iObj_set_activeForm,                   &iObj_get_activeForm                    },
		{   cgc_autoRelease,                sizeof(cgc_autoRelease) - 1,                 &iObj_set_autoRelease,                  &iObj_get_autoRelease                   },
		{   cgc_bufferMode,                 sizeof(cgc_bufferMode) - 1,                  &iObj_set_bufferMode,                   &iObj_get_bufferMode                    },
		{   cgc_dataSession,                sizeof(cgc_dataSession) - 1,                 &iObj_set_dataSession,                  &iObj_get_dataSession                   },
		{   cgc_dataSessionID,              sizeof(cgc_dataSessionID) - 1,               &iObj_set_dataSessionID,                &iObj_get_dataSessionID                 },
		{   cgc_dataEnvironment,            sizeof(cgc_dataEnvironment) - 1,             &iObj_set_dataEnvironment,              &iObj_get_dataEnvironment               },
		...
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_forms,                      sizeof(cgc_forms) - 1,                       &iObj_set_forms,                        &iObj_get_forms                         },
		{   cgc_formCount,                  sizeof(cgc_formCount) - 1,                   &iObj_set_formCount,                    &iObj_get_formCount                     },
		{   cgc_objects,                    sizeof(cgc_objects) - 1,                     &iObj_set_objects,                      &iObj_get_objects                       },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_parent,                     sizeof(cgc_parent) - 1,                      &iObj_set_parent,                       &iObj_get_parent                        },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_readBackColor,              sizeof(cgc_readBackColor) - 1,               &iObj_set_readBackColor,                &iObj_get_readBackColor                 },
		{   cgc_readCycle,                  sizeof(cgc_readCycle) - 1,                   &iObj_set_readCycle,                    &iObj_get_readCycle                     },
		{   cgc_readForeColor,              sizeof(cgc_readForeColor) - 1,               &iObj_set_readForeColor,                &iObj_get_readForeColor                 },
		{   cgc_readLock,                   sizeof(cgc_readLock) - 1,                    &iObj_set_readLock,                     &iObj_get_readLock                      },
		{   cgc_readMouse,                  sizeof(cgc_readMouse) - 1,                   &iObj_set_readMouse,                    &iObj_get_readMouse                     },
		{   cgc_readSave,                   sizeof(cgc_readSave) - 1,                    &iObj_set_readSave,                     &iObj_get_readSave                      },
		{   cgc_readTimeOut,                sizeof(cgc_readTimeOut) - 1,                 &iObj_set_readTimeOut,                  &iObj_get_readTimeOut                   },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_visible,                    sizeof(cgc_visible) - 1,                     &iObj_set_visible,                      &iObj_get_visible                       },
		{   cgc_windowList,                 sizeof(cgc_windowList) - 1,                  &iObj_set_windowList,                   &iObj_get_windowList                    },
		{   cgc_windowType,                 sizeof(cgc_windowType) - 1,                  &iObj_set_windowType,                   &iObj_get_windowType                    },
		{   NULL,                           0,                                           0,                                      0                                       }
	};
	...
	SPropertyMap gcProps_toolbar[] = 
	{
		...
		{   cgc_parent,                     sizeof(cgc_parent) - 1,                      &iObj_set_parent,                       &iObj_get_parent                        },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_sizable,                    sizeof(cgc_sizable) - 1,                     &iObj_set_sizable,                      &iObj_get_sizable                       },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_themes,                     sizeof(cgc_themes) - 1,                      &iObj_set_themes,                       &iObj_get_themes                        },
		{   cgc_top,                        sizeof(cgc_top) - 1,                         &iObj_set_top,                          &iObj_get_top                           },
		{   cgc_visible,                    sizeof(cgc_visible) - 1,                     &iObj_set_visible,                      &iObj_get_visible                       },
	...
	SPropertyMap gcProps_line[] = 
	{
		...
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_borderColor,                sizeof(cgc_borderColor) - 1,                 &iObj_set_borderColor,                  &iObj_get_borderColor                   },
		{   cgc_borderWidth,                sizeof(cgc_borderWidth) - 1,                 &iObj_set_borderWidth,                  &iObj_get_borderWidth                   },
		{   cgc_borderStyle,                sizeof(cgc_borderStyle) - 1,                 &iObj_set_borderStyle,                  &iObj_get_borderStyle                   },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_dragIcon,                   sizeof(cgc_dragIcon) - 1,                    &iObj_set_dragIcon,                     &iObj_get_dragIcon                      },
		...
		{   cgc_helpContextID,              sizeof(cgc_helpContextID) - 1,               &iObj_set_helpContextID,                &iObj_get_helpContextID                 },
		{   cgc_left,                       sizeof(cgc_left) - 1,                        &iObj_set_left,                         &iObj_get_left                          },
		{   cgc_lineSlant,                  sizeof(cgc_lineSlant) - 1,                   &iObj_set_lineSlant,                    &iObj_get_lineSlant                     },
		{   cgc_mousePointer,               sizeof(cgc_mousePointer) - 1,                &iObj_set_mousePointer,                 &iObj_get_mousePointer                  },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_oLEDragMode,                sizeof(cgc_oLEDragMode) - 1,                 &iObj_set_oLEDragMode,                  &iObj_get_oLEDragMode                   },
		{   cgc_oLEDragPicture,             sizeof(cgc_oLEDragPicture) - 1,              &iObj_set_oLEDragPicture,               &iObj_get_oLEDragPicture                },
		...
		{   cgc_parent,                     sizeof(cgc_parent) - 1,                      &iObj_set_parent,                       &iObj_get_parent                        },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_polyPoints,                 sizeof(cgc_polyPoints) - 1,                  &iObj_set_polyPoints,                   &iObj_get_polyPoints                    },
		{   cgc_rotation,                   sizeof(cgc_rotation) - 1,                    &iObj_set_rotation,                     &iObj_get_rotation                      },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_toolTipText,                sizeof(cgc_toolTipText) - 1,                 &iObj_set_toolTipText,                  &iObj_get_toolTipText                   },
	...
	SPropertyMap gcProps_shape[] = 
	{
		...
		{   cgc_borderWidth,                sizeof(cgc_borderWidth) - 1,                 &iObj_set_borderWidth,                  &iObj_get_borderWidth                   },
		{   cgc_borderStyle,                sizeof(cgc_borderStyle) - 1,                 &iObj_set_borderStyle,                  &iObj_get_borderStyle                   },
		{   cgc_curvature,                  sizeof(cgc_curvature) - 1,                   &iObj_set_curvature,                    &iObj_get_curvature                     },
		{   cgc_colorScheme,                sizeof(cgc_colorScheme) - 1,                 &iObj_set_colorScheme,                  &iObj_get_colorScheme                   },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		{   cgc_backColor,                  sizeof(cgc_backColor) - 1,                   &iObj_set_backColor,                    &iObj_get_backColor                     },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
	...
	SPropertyMap gcProps_image[] = 
	{
		...
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_picture,                    sizeof(cgc_picture) - 1,                     &iObj_set_picture,                      &iObj_get_picture                       },
		{   cgc_pictureVal,                 sizeof(cgc_pictureVal) - 1,                  &iObj_set_pictureVal,                   &iObj_get_pictureVal                    },
		{   cgc_rotateFlip,                 sizeof(cgc_rotateFlip) - 1,                  &iObj_set_rotateFlip,                   &iObj_get_rotateFlip                    },
		{   cgc_stretch,                    sizeof(cgc_stretch) - 1,                     &iObj_set_stretch,                      &iObj_get_stretch                       },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_themes,                     sizeof(cgc_themes) - 1,                      &iObj_set_themes,                       &iObj_get_themes                        },
		{   cgc_toolTipText,                sizeof(cgc_toolTipText) - 1,                 &iObj_set_toolTipText,                  &iObj_get_toolTipText                   },
	...
	{
		{   cgc_activeColumn,               sizeof(cgc_activeColumn) - 1,                &iObj_set_activeColumn,                 &iObj_get_activeColumn                  },
		{   cgc_activeRow,                  sizeof(cgc_activeRow) - 1,                   &iObj_set_activeRow,                    &iObj_get_activeRow                     },
		{   cgc_allowAddNew,                sizeof(cgc_allowAddNew) - 1,                 &iObj_set_allowAddNew,                  &iObj_get_allowAddNew                   },
		{   cgc_allowAutoColumnFit,         sizeof(cgc_allowAutoColumnFit) - 1,          &iObj_set_allowAutoColumnFit,           &iObj_get_allowAutoColumnFit            },
		{   cgc_allowCellSelection,         sizeof(cgc_allowCellSelection) - 1,          &iObj_set_allowCellSelection,           &iObj_get_allowCellSelection            },
		{   cgc_allowHeaderSizing,          sizeof(cgc_allowHeaderSizing) - 1,           &iObj_set_allowHeaderSizing,            &iObj_get_allowHeaderSizing             },
		{   cgc_allowRowSizing,             sizeof(cgc_allowRowSizing) - 1,              &iObj_set_allowRowSizing,               &iObj_get_allowRowSizing                },
		{   cgc_gridLineColor,              sizeof(cgc_gridLineColor) - 1,               &iObj_set_gridLineColor,                &iObj_get_gridLineColor                 },
		{   cgc_gridLines,                  sizeof(cgc_gridLines) - 1,                   &iObj_set_gridLines,                    &iObj_get_gridLines                     },
		{   cgc_gridLineWidth,              sizeof(cgc_gridLineWidth) - 1,               &iObj_set_gridLineWidth,                &iObj_get_gridLineWidth                 },
		{   cgc_headerHeight,               sizeof(cgc_headerHeight) - 1,                &iObj_set_headerHeight,                 &iObj_get_headerHeight                  },
		{   cgc_highLight,                  sizeof(cgc_highLight) - 1,                   &iObj_set_highLight,                    &iObj_get_highLight                     },
		{   cgc_highlightBackColor,         sizeof(cgc_highlightBackColor) - 1,          &iObj_set_highlightBackColor,           &iObj_get_highlightBackColor            },
		{   cgc_highlightForeColor,         sizeof(cgc_highlightForeColor) - 1,          &iObj_set_highlightForeColor,           &iObj_get_highlightForeColor            },
		{   cgc_highlightStyle,             sizeof(cgc_highlightStyle) - 1,              &iObj_set_highlightStyle,               &iObj_get_highlightStyle                },
		{   cgc_highLightRow,               sizeof(cgc_highLightRow) - 1,                &iObj_set_highLightRow,                 &iObj_get_highLightRow                  },
		{   cgc_highlightRowLineWidth,      sizeof(cgc_highlightRowLineWidth) - 1,       &iObj_set_highlightRowLineWidth,        &iObj_get_highlightRowLineWidth         },
		{   cgc_leftColumn,                 sizeof(cgc_leftColumn) - 1,                  &iObj_set_leftColumn,                   &iObj_get_leftColumn                    },
		{   cgc_linkMaster,                 sizeof(cgc_linkMaster) - 1,                  &iObj_set_linkMaster,                   &iObj_get_linkMaster                    },
		{   cgc_childOrder,                 sizeof(cgc_childOrder) - 1,                  &iObj_set_childOrder,                   &iObj_get_childOrder                    },
		{   cgc_lockColumns,                sizeof(cgc_lockColumns) - 1,                 &iObj_set_lockColumns,                  &iObj_get_lockColumns                   },
		{   cgc_lockColumnsLeft,            sizeof(cgc_lockColumnsLeft) - 1,             &iObj_set_lockColumnsLeft,              &iObj_get_lockColumnsLeft               },
		{   cgc_memberClass,                sizeof(cgc_memberClass) - 1,                 &iObj_set_memberClass,                  &iObj_get_memberClass                   },
		{   cgc_memberClassLibrary,         sizeof(cgc_memberClassLibrary) - 1,          &iObj_set_memberClassLibrary,           &iObj_get_memberClassLibrary            },
		{   cgc_optimize,                   sizeof(cgc_optimize) - 1,                    &iObj_set_optimize,                     &iObj_get_optimize                      },
		{   cgc_partition,                  sizeof(cgc_partition) - 1,                   &iObj_set_partition,                    &iObj_get_partition                     },
		{   cgc_panelLink,                  sizeof(cgc_panelLink) - 1,                   &iObj_set_panelLink,                    &iObj_get_panelLink                     },
		{   cgc_panel,                      sizeof(cgc_panel) - 1,                       &iObj_set_panel,                        &iObj_get_panel                         },
		{   cgc_splitBar,                   sizeof(cgc_splitBar) - 1,                    &iObj_set_splitBar,                     &iObj_get_splitBar                      },
		{   cgc_deleteMark,                 sizeof(cgc_deleteMark) - 1,                  &iObj_set_deleteMark,                   &iObj_get_deleteMark                    },
		{   cgc_recordMark,                 sizeof(cgc_recordMark) - 1,                  &iObj_set_recordMark,                   &iObj_get_recordMark                    },
		{   cgc_relativeColumn,             sizeof(cgc_relativeColumn) - 1,              &iObj_set_relativeColumn,               &iObj_get_relativeColumn                },
		{   cgc_relativeRow,                sizeof(cgc_relativeRow) - 1,                 &iObj_set_relativeRow,                  &iObj_get_relativeRow                   },
		{   cgc_view,                       sizeof(cgc_view) - 1,                        &iObj_set_view,                         &iObj_get_view                          },
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_columns,                    sizeof(cgc_columns) - 1,                     &iObj_set_columns,                      &iObj_get_columns                       },
		{   cgc_columnCount,                sizeof(cgc_columnCount) - 1,                 &iObj_set_columnCount,                  &iObj_get_columnCount                   },
		{   cgc_objects,                    sizeof(cgc_objects) - 1,                     &iObj_set_objects,                      &iObj_get_objects                       },
		{   cgc_foreColor,                  sizeof(cgc_foreColor) - 1,                   &iObj_set_foreColor,                    &iObj_get_foreColor                     },
		{   cgc_backColor,                  sizeof(cgc_backColor) - 1,                   &iObj_set_backColor,                    &iObj_get_backColor                     },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_recordSource,               sizeof(cgc_recordSource) - 1,                &iObj_set_recordSource,                 &iObj_get_recordSource                  },
		{   cgc_recordSourceType,           sizeof(cgc_recordSourceType) - 1,            &iObj_set_recordSourceType,             &iObj_get_recordSourceType              },
		{   cgc_dragIcon,                   sizeof(cgc_dragIcon) - 1,                    &iObj_set_dragIcon,                     &iObj_get_dragIcon                      },
		{   cgc_dragMode,                   sizeof(cgc_dragMode) - 1,                    &iObj_set_dragMode,                     &iObj_get_dragMode                      },
		{   cgc_enabled,                    sizeof(cgc_enabled) - 1,                     &iObj_set_enabled,                      &iObj_get_enabled                       },
		{   cgc_fontBold,                   sizeof(cgc_fontBold) - 1,                    &iObj_set_fontBold,                     &iObj_get_fontBold                      },
		...
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_readOnly,                   sizeof(cgc_readOnly) - 1,                    &iObj_set_readOnly,                     &iObj_get_readOnly                      },
		{   cgc_relationalExpr,             sizeof(cgc_relationalExpr) - 1,              &iObj_set_relationalExpr,               &iObj_get_relationalExpr                },
		{   cgc_rightToLeft,                sizeof(cgc_rightToLeft) - 1,                 &iObj_set_rightToLeft,                  &iObj_get_rightToLeft                   },
		{   cgc_rowColChange,               sizeof(cgc_rowColChange) - 1,                &iObj_set_rowColChange,                 &iObj_get_rowColChange                  },
		{   cgc_rowHeight,                  sizeof(cgc_rowHeight) - 1,                   &iObj_set_rowHeight,                    &iObj_get_rowHeight                     },
		{   cgc_scrollBars,                 sizeof(cgc_scrollBars) - 1,                  &iObj_set_scrollBars,                   &iObj_get_scrollBars                    },
		{   cgc_selectedItemBackColor,      sizeof(cgc_selectedItemBackColor) - 1,       &iObj_set_selectedItemBackColor,        &iObj_get_selectedItemBackColor         },
		{   cgc_selectedItemForeColor,      sizeof(cgc_selectedItemForeColor) - 1,       &iObj_set_selectedItemForeColor,        &iObj_get_selectedItemForeColor         },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
	...
	{
		{   cgc_currentControl,             sizeof(cgc_currentControl) - 1,              &iObj_set_currentControl,               &iObj_get_currentControl                },
		{   cgc_dynamicAlignment,           sizeof(cgc_dynamicAlignment) - 1,            &iObj_set_dynamicAlignment,             &iObj_get_dynamicAlignment              },
		{   cgc_dynamicBackColor,           sizeof(cgc_dynamicBackColor) - 1,            &iObj_set_dynamicBackColor,             &iObj_get_dynamicBackColor              },
		{   cgc_dynamicCurrentControl,      sizeof(cgc_dynamicCurrentControl) - 1,       &iObj_set_dynamicCurrentControl,        &iObj_get_dynamicCurrentControl         },
		{   cgc_dynamicFontBold,            sizeof(cgc_dynamicFontBold) - 1,             &iObj_set_dynamicFontBold,              &iObj_get_dynamicFontBold               },
		{   cgc_dynamicFontItalic,          sizeof(cgc_dynamicFontItalic) - 1,           &iObj_set_dynamicFontItalic,            &iObj_get_dynamicFontItalic             },
		{   cgc_dynamicFontName,            sizeof(cgc_dynamicFontName) - 1,             &iObj_set_dynamicFontName,              &iObj_get_dynamicFontName               },
		{   cgc_dynamicFontOutline,         sizeof(cgc_dynamicFontOutline) - 1,          &iObj_set_dynamicFontOutline,           &iObj_get_dynamicFontOutline            },
		{   cgc_dynamicFontShadow,          sizeof(cgc_dynamicFontShadow) - 1,           &iObj_set_dynamicFontShadow,            &iObj_get_dynamicFontShadow             },
		{   cgc_dynamicFontSize,            sizeof(cgc_dynamicFontSize) - 1,             &iObj_set_dynamicFontSize,              &iObj_get_dynamicFontSize               },
		{   cgc_dynamicFontStrikeThru,      sizeof(cgc_dynamicFontStrikeThru) - 1,       &iObj_set_dynamicFontStrikeThru,        &iObj_get_dynamicFontStrikeThru         },
		{   cgc_dynamicFontUnderline,       sizeof(cgc_dynamicFontUnderline) - 1,        &iObj_set_dynamicFontUnderline,         &iObj_get_dynamicFontUnderline          },
		{   cgc_dynamicForeColor,           sizeof(cgc_dynamicForeColor) - 1,            &iObj_set_dynamicForeColor,             &iObj_get_dynamicForeColor              },
		{   cgc_dynamicInputMask,           sizeof(cgc_dynamicInputMask) - 1,            &iObj_set_dynamicInputMask,             &iObj_get_dynamicInputMask              },
		{   cgc_sparse,                     sizeof(cgc_sparse) - 1,                      &iObj_set_sparse,                       &iObj_get_sparse                        },
		{   cgc_columnOrder,                sizeof(cgc_columnOrder) - 1,                 &iObj_set_columnOrder,                  &iObj_get_columnOrder                   },
		{   cgc_headerClass,                sizeof(cgc_headerClass) - 1,                 &iObj_set_headerClass,                  &iObj_get_headerClass                   },
		{   cgc_headerClassLibrary,         sizeof(cgc_headerClassLibrary) - 1,          &iObj_set_headerClassLibrary,           &iObj_get_headerClassLibrary            },
		{   cgc_movable,                    sizeof(cgc_movable) - 1,                     &iObj_set_movable,                      &iObj_get_movable                       },
		{   cgc_alignment,                  sizeof(cgc_alignment) - 1,                   &iObj_set_alignment,                    &iObj_get_alignment                     },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		...
		{   cgc_controlCount,               sizeof(cgc_controlCount) - 1,                &iObj_set_controlCount,                 &iObj_get_controlCount                  },
		{   cgc_objects,                    sizeof(cgc_objects) - 1,                     &iObj_set_objects,                      &iObj_get_objects                       },
		{   cgc_bound,                      sizeof(cgc_bound) - 1,                       &iObj_set_bound,                        &iObj_get_bound                         },
		{   cgc_foreColor,                  sizeof(cgc_foreColor) - 1,                   &iObj_set_foreColor,                    &iObj_get_foreColor                     },
		{   cgc_backColor,                  sizeof(cgc_backColor) - 1,                   &iObj_set_backColor,                    &iObj_get_backColor                     },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_controlSource,              sizeof(cgc_controlSource) - 1,               &iObj_set_controlSource,                &iObj_get_controlSource                 },
		...
		{   cgc_readOnly,                   sizeof(cgc_readOnly) - 1,                    &iObj_set_readOnly,                     &iObj_get_readOnly                      },
		{   cgc_selectOnEntry,              sizeof(cgc_selectOnEntry) - 1,               &iObj_set_selectOnEntry,                &iObj_get_selectOnEntry                 },
		{   cgc_resizable,                  sizeof(cgc_resizable) - 1,                   &iObj_set_resizable,                    &iObj_get_resizable                     },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_toolTipText,                sizeof(cgc_toolTipText) - 1,                 &iObj_set_toolTipText,                  &iObj_get_toolTipText                   },
		{   cgc_visible,                    sizeof(cgc_visible) - 1,                     &iObj_set_visible,                      &iObj_get_visible                       },
	...
	{
		{   cgc_autoActivate,               sizeof(cgc_autoActivate) - 1,                &iObj_set_autoActivate,                 &iObj_get_autoActivate                  },
		{   cgc_autoSize,                   sizeof(cgc_autoSize) - 1,                    &iObj_set_autoSize,                     &iObj_get_autoSize                      },
		{   cgc_autoVerbMenu,               sizeof(cgc_autoVerbMenu) - 1,                &iObj_set_autoVerbMenu,                 &iObj_get_autoVerbMenu                  },
		{   cgc_documentFile,               sizeof(cgc_documentFile) - 1,                &iObj_set_documentFile,                 &iObj_get_documentFile                  },
		{   cgc_hostName,                   sizeof(cgc_hostName) - 1,                    &iObj_set_hostName,                     &iObj_get_hostName                      },
		{   cgc_object,                     sizeof(cgc_object) - 1,                      &iObj_set_object,                       &iObj_get_object                        },
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		...
		{   cgc_mousePointer,               sizeof(cgc_mousePointer) - 1,                &iObj_set_mousePointer,                 &iObj_get_mousePointer                  },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_oLEClass,                   sizeof(cgc_oLEClass) - 1,                    &iObj_set_oLEClass,                     &iObj_get_oLEClass                      },
		{   cgc_oLELCID,                    sizeof(cgc_oLELCID) - 1,                     &iObj_set_oLELCID,                      &iObj_get_oLELCID                       },
		{   cgc_oLETypeAllowed,             sizeof(cgc_oLETypeAllowed) - 1,              &iObj_set_oLETypeAllowed,               &iObj_get_oLETypeAllowed                },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
		{   cgc_sizable,                    sizeof(cgc_sizable) - 1,                     &iObj_set_sizable,                      &iObj_get_sizable                       },
		{   cgc_stretch,                    sizeof(cgc_stretch) - 1,                     &iObj_set_stretch,                      &iObj_get_stretch                       },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
	...
	SPropertyMap gcProps_olecontain[] = 
	{
		...
		{   cgc_hostName,                   sizeof(cgc_hostName) - 1,                    &iObj_set_hostName,                     &iObj_get_hostName                      },
		{   cgc_object,                     sizeof(cgc_object) - 1,                      &iObj_set_object,                       &iObj_get_object                        },
		{   cgc_align,                      sizeof(cgc_align) - 1,                       &iObj_set_align,                        &iObj_get_align                         },
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
	...
	{
		{   cgc_spinnerHighValue,           sizeof(cgc_spinnerHighValue) - 1,            &iObj_set_spinnerHighValue,             &iObj_get_spinnerHighValue              },
		{   cgc_spinnerLowValue,            sizeof(cgc_spinnerLowValue) - 1,             &iObj_set_spinnerLowValue,              &iObj_get_spinnerLowValue               },
		{   cgc_keyboardHighValue,          sizeof(cgc_keyboardHighValue) - 1,           &iObj_set_keyboardHighValue,            &iObj_get_keyboardHighValue             },
		{   cgc_keyboardLowValue,           sizeof(cgc_keyboardLowValue) - 1,            &iObj_set_keyboardLowValue,             &iObj_get_keyboardLowValue              },
		{   cgc_increment,                  sizeof(cgc_increment) - 1,                   &iObj_set_increment,                    &iObj_get_increment                     },
		{   cgc_alignment,                  sizeof(cgc_alignment) - 1,                   &iObj_set_alignment,                    &iObj_get_alignment                     },
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
	...
	{
		{   cgc_interval,                   sizeof(cgc_interval) - 1,                    &iObj_set_interval,                     &iObj_get_interval                      },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
	...
	{
		{   cgc_keySort,                    sizeof(cgc_keySort) - 1,                     &iObj_set_keySort,                      &iObj_get_keySort                       },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_count,                      sizeof(cgc_count) - 1,                       &iObj_set_count,                        &iObj_get_count                         },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },
		{   cgc_name,                       sizeof(cgc_name) - 1,                        &iObj_set_name,                         &iObj_get_name                          },
		{   cgc_parent,                     sizeof(cgc_parent) - 1,                      &iObj_set_parent,                       &iObj_get_parent                        },
		{   cgc_parentClass,                sizeof(cgc_parentClass) - 1,                 &iObj_set_parentClass,                  &iObj_get_parentClass                   },
	...
	{
		{   cgc_activeControl,              sizeof(cgc_activeControl) - 1,               &iObj_set_activeControl,                &iObj_get_activeControl                 },
		{   cgc_pageOrder,                  sizeof(cgc_pageOrder) - 1,                   &iObj_set_pageOrder,                    &iObj_get_pageOrder                     },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_backStyle,                  sizeof(cgc_backStyle) - 1,                   &iObj_set_backStyle,                    &iObj_get_backStyle                     },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
	...
	{
		{   cgc_activePage,                 sizeof(cgc_activePage) - 1,                  &iObj_set_activePage,                   &iObj_get_activePage                    },
		{   cgc_tabOrientation,             sizeof(cgc_tabOrientation) - 1,              &iObj_set_tabOrientation,               &iObj_get_tabOrientation                },
		{   cgc_tabs,                       sizeof(cgc_tabs) - 1,                        &iObj_set_tabs,                         &iObj_get_tabs                          },
		{   cgc_pageHeight,                 sizeof(cgc_pageHeight) - 1,                  &iObj_set_pageHeight,                   &iObj_get_pageHeight                    },
		{   cgc_pageWidth,                  sizeof(cgc_pageWidth) - 1,                   &iObj_set_pageWidth,                    &iObj_get_pageWidth                     },
		{   cgc_anchor,                     sizeof(cgc_anchor) - 1,                      &iObj_set_anchor,                       &iObj_get_anchor                        },
		{   cgc_application,                sizeof(cgc_application) - 1,                 &iObj_set_application,                  &iObj_get_application                   },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_pages,                      sizeof(cgc_pages) - 1,                       &iObj_set_pages,                        &iObj_get_pages                         },
		{   cgc_pageCount,                  sizeof(cgc_pageCount) - 1,                   &iObj_set_pageCount,                    &iObj_get_pageCount                     },
		{   cgc_objects,                    sizeof(cgc_objects) - 1,                     &iObj_set_objects,                      &iObj_get_objects                       },
		{   cgc_borderColor,                sizeof(cgc_borderColor) - 1,                 &iObj_set_borderColor,                  &iObj_get_borderColor                   },
		{   cgc_borderWidth,                sizeof(cgc_borderWidth) - 1,                 &iObj_set_borderWidth,                  &iObj_get_borderWidth                   },
		{   cgc_colorSource,                sizeof(cgc_colorSource) - 1,                 &iObj_set_colorSource,                  &iObj_get_colorSource                   },
		...
		{   cgc_specialEffect,              sizeof(cgc_specialEffect) - 1,               &iObj_set_specialEffect,                &iObj_get_specialEffect                 },
		{   cgc_statusBarText,              sizeof(cgc_statusBarText) - 1,               &iObj_set_statusBarText,                &iObj_get_statusBarText                 },
		{   cgc_tabStyle,                   sizeof(cgc_tabStyle) - 1,                    &iObj_set_tabStyle,                     &iObj_get_tabStyle                      },
		{   cgc_tabIndex,                   sizeof(cgc_tabIndex) - 1,                    &iObj_set_tabIndex,                     &iObj_get_tabIndex                      },
		{   cgc_tabStop,                    sizeof(cgc_tabStop) - 1,                     &iObj_set_tabStop,                      &iObj_get_tabStop                       },
		{   cgc_tag,                        sizeof(cgc_tag) - 1,                         &iObj_set_tag,                          &iObj_get_tag                           },
		{   cgc_themes,                     sizeof(cgc_themes) - 1,                      &iObj_set_themes,                       &iObj_get_themes                        },
	...
	{
		{   cgc_details,                    sizeof(cgc_details) - 1,                     &iObj_set_details,                      &iObj_get_details                       },
		{   cgc_errorNo,                    sizeof(cgc_errorNo) - 1,                     &iObj_set_errorNo,                      &iObj_get_errorNo                       },
		{   cgc_lineContents,               sizeof(cgc_lineContents) - 1,                &iObj_set_lineContents,                 &iObj_get_lineContents                  },
		{   cgc_lineNo,                     sizeof(cgc_lineNo) - 1,                      &iObj_set_lineNo,                       &iObj_get_lineNo                        },
		{   cgc_message,                    sizeof(cgc_message) - 1,                     &iObj_set_message,                      &iObj_get_message                       },
		{   cgc_procedure,                  sizeof(cgc_procedure) - 1,                   &iObj_set_procedure,                    &iObj_get_procedure                     },
		{   cgc_stackLevel,                 sizeof(cgc_stackLevel) - 1,                  &iObj_set_stackLevel,                   &iObj_get_stackLevel                    },
		{   cgc_userValue,                  sizeof(cgc_userValue) - 1,                   &iObj_set_userValue,                    &iObj_get_userValue                     },
		{   cgc_baseClass,                  sizeof(cgc_baseClass) - 1,                   &iObj_set_baseClass,                    &iObj_get_baseClass                     },
		{   cgc_class,                      sizeof(cgc_class) - 1,                       &iObj_set_class,                        &iObj_get_class                         },
		{   cgc_classLibrary,               sizeof(cgc_classLibrary) - 1,                &iObj_set_classLibrary,                 &iObj_get_classLibrary                  },
		{   cgc_comment,                    sizeof(cgc_comment) - 1,                     &iObj_set_comment,                      &iObj_get_comment                       },

...
//////
	...
	struct SPropertyInits
	{
		...
		union {
			u32			_setter;
			bool		(*setterOVar)	(SObject* obj, SVariable* var);
	...
	struct SPropertyMap
	{
		...
		union {
			u32			_setter;
			bool		(*setterOverrideVar)	(SObject* obj, SVariable* var);
			bool		(*setterOverrideBmp)	(SObject* obj, SBitmap* bmp);
		};

		union {
			u32			_getter;
			SVariable*	(*getterOverrideVar)	(SObject* obj);
			SBitmap*	(*getterOverrideBmp)	(SObject* obj);
		};
	};

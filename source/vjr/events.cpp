...
void iEvents_resetToDefault(SEvents* ev)
{
	...
	if (ev)
	{
		...
		//////
			...
			*(u32*)&g->activate				= (u32)&iDefaultCallback_onActivate;
			*(u32*)&g->deactivate			= (u32)&iDefaultCallback_onDeactivate;
			*(u32*)&g->onSelect				= (u32)&iDefaultCallback_onSelect;
			*(u32*)&g->onDeselect			= (u32)&iDefaultCallback_onDeselect;
			*(u32*)&g->onInteractiveChange	= (u32)&iDefaultCallback_onInteractiveChange;
			*(u32*)&g->onProgrammaticChange	= (u32)&iDefaultCallback_onProgrammaticChange;
		...
		//////
			...
			*(u32*)&m->onMouseDblClickEx	= (u32)&iDefaultCallback_onMouseDblClickEx;

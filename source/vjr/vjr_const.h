...
//////
	...
	const s8			cgcScreenTitle[]					= "Visual FreePro, Jr. 0.37 -- Jul.28.2014";
	const s8			cgcJDebiTitle[]						= "JDebi Debugger 0.37 -- Jul.28.2014";
	...
	const s8			cgcVersionText[]					= "Visual FreePro, Jr. 00.37.9999.9999 for Windows";
	const s8			cgcVersion1Text[]					= "Visual FreePro, Jr. 00.37.9999.9999 for Windows [Jul.28.2014 00:00:00] Product ID 31415-926-5358979-32384";
	const s32			gnVersion2							= 2;	// Professional
	const s32			gnVersion3							= 0;	// English
	const s8			cgcVersion4Text[]					= "00.37.9999.9999";
	const s32			gnVersion5							= 37;	// 0.37

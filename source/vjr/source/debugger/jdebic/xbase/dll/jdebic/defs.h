//////////
//
// /libsf/source/vjr/source/debugger/jdebic/xbase/dll/defs.h
//
//////
//    _     _ _     _____ _____
//   | |   (_) |__ / ____|  ___|
...
//////
	// Create/connect to a pipe, the handle will be closed at the end of life of this DLL
	...
	DWORD WINAPI		ijdebic_messageThread					(LPVOID param);		// Runs in separate thread, handles messages from remote processes

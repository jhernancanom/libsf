...
//////
	...
	SBasePropertyInit gsProps_master[] =
	{
		...
		{	_INDEX_SET_REPROCESS_SYSTEM,			cgc_setReprocess,				sizeof(cgc_setReprocess) - 1,				_VAR_TYPE_LOGICAL,			0, 0, 0,		_LOGICAL_TRUE					,NULL	},	// .t.=Reprocessing is set to automatic, .f. is not supported, if it's not .t. it must be signed numeric with negative indicating attempts, and positive indicating seconds
	...
	{	// 
		...
		{	_INDEX_SET_REPROCESS_SYSTEM,				0, 0, 0 },		// bool or s32

...
//////
	...
	void				ifunction_chrtran_common					(SThisCode* thisCode, SVariable* varString, SVariable* varSearch, SVariable* varReplace, bool tlCaseSensitive, SFunctionParms* rpar);
	...
	void				ifunction_colorize_common					(SThisCode* thisCode, SVariable* varColor, SVariable* varColorTarget, SVariable* varPercentage, bool tlApplyColorTarget, SFunctionParms* rpar);
	...
	void				ifunction_ctox_common						(SThisCode* thisCode, SVariable* varString, bool tlIncludeTime);
	...
	void				ifunction_day_month_year_common				(SThisCode* thisCode, SVariable* varParam, u32 tnFunctionType);
	void				function_dmy		/* Stefano D'Amico */	(SThisCode* thisCode, SFunctionParms* rpar);
	void				ifunction_dtoc_common						(SThisCode* thisCode, SVariable* varParam, u32 tnFunctionType);
	...
	void				ifunction_hhmmss_common						(SThisCode* thisCode, SVariable* varParam, u32 tnFunctionType);
	...
	void				ifunction_pad_common						(SThisCode* thisCode, SVariable* varExpr, SVariable* varResultSize, SVariable* varPadCharacter, bool tlPadLeft, bool tlPadRight, SFunctionParms* rpar);
	...
	void				ifunction_ranger_common						(SThisCode* thisCode, SVariable* varExpr, SVariable* varMin, SVariable* varMax, bool* tlRanged, SFunctionParms* rpar);
	...
	void				ifunction_sign_common						(SThisCode* thisCode, SVariable* varNumber, bool tlIncrementZero, SFunctionParms* rpar);
	...
	void				ifunction_strtran_common					(SThisCode* thisCode, SVariable* varString, SVariable* varSearch, SVariable* varReplace, SVariable* varRecursiveCount, bool tlCaseSensitive, SFunctionParms* rpar);
	void				function_stuff								(SThisCode* thisCode, SFunctionParms* rpar);
	void				function_sys								(SThisCode* thisCode, SFunctionParms* rpar);
	void				iFunction_sys2015							(SThisCode* thisCode, u32 tnPrefixWidth, u32 tnPostfixWidth, SFunctionParms* rpar);
	...
	void				ifunction_type_common						(SThisCode* thisCode, SVariable* var, bool tlExtraInfo, bool tlIsVartype, bool tlNullIsType);

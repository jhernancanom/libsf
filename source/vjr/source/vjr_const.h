...
//////
	...
	#define propIsFalse(obj, index)						(iObjProp_get_logical_direct	(obj, index)			== _LOGICAL_FALSE)
	#define propIsTrue(obj, index)						(iObjProp_get_logical_direct	(obj, index)			!= _LOGICAL_FALSE)
	#define propIsVisible(obj)							(iObjProp_get_logical_direct	(obj, _INDEX_VISIBLE)	!= _LOGICAL_FALSE)
	#define propIsEnabled(obj)							(iObjProp_get_logical_direct	(obj, _INDEX_ENABLED)	!= _LOGICAL_FALSE)
	#define propIsReadonly(obj)							(iObjProp_get_logical_direct	(obj, _INDEX_READONLY)	!= _LOGICAL_FALSE)
	#define propIsName(obj, text)						(iObjProp_compare_character		(obj, _INDEX_NAME,				(s8*)text,		sizeof(text) - 1) == 0)
	...
	#define propTitleBar(obj)							(iObjProp_get_logical_direct	(obj, _INDEX_TITLEBAR)	!= _LOGICAL_FALSE)
	...
	#define propSetVisible(obj, value)					iObjProp_set_logical_direct		(obj, _INDEX_VISIBLE,			value)
	#define propSetEnabled(obj, value)					iObjProp_set_logical_direct		(obj, _INDEX_ENABLED,			value);
	...
	#define propSetMultiSelect(obj, value)				iObjProp_set_logical_direct		(obj, _INDEX_MULTISELECT,		value)
	...
	#define propGet_settings_LoadReceivesParams(obj)			(iObjProp_get_logical_direct	(obj, _INDEX_SET_LOAD_RECEIVES_PARAMS)	!= _LOGICAL_FALSE)
